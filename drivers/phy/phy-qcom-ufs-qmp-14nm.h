...
#define QSERDES_RX_RX_EQU_ADAPTOR_CNTRL4	RX_OFF(0, 0xE0)
...
static struct ufs_qcom_phy_calibration phy_cal_table_rate_A_2_2_0[] = {
	...
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_RX_RX_EQU_ADAPTOR_CNTRL2, 0x01), /* Enable RX EQ */
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_RX_RX_EQU_ADAPTOR_CNTRL4, 0xBB), /* RX Gain = 4dB */
#else
	UFS_QCOM_PHY_CAL_ENTRY(QSERDES_RX_RX_EQU_ADAPTOR_CNTRL2, 0x0D),
#endif
