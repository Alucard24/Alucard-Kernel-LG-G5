 ...
 *
 * $Id: wl_cfg80211.c 613464 2016-01-19 04:22:10Z $
 */
/* */
#include <typedefs.h>
#include <linuxver.h>
	...
	struct vif_params *params)
{
	...
	if (cfg->p2p_supported && (wlif_type != -1)) {
		...
		timeout = wait_event_interruptible_timeout(cfg->netif_change_event,
			((wl_get_p2p_status(cfg, IF_ADDING) == false) && (cfg->if_event_info.valid)),
...
int wl_cfg80211_lps(struct net_device *dev, u32 reason)
{
	...
	cfg80211_disconnected(dev, msg, NULL, 0, false, GFP_KERNEL);
